...
def main(args):
    ...
    def build_dictionary(filenames, modality, src=False, tgt=False):
        ...
        # else:
        tokenize_func = tokenizer.tokenize_line
    ...
    if args['preprocess']['joined_dictionary']:
        ...
        if args['preprocess']['srcdict']:
            ...
            src_dict = build_dictionary(
                ...
                + [valid_path(lang2) for lang2 in [args['preprocess']['source_lang'], args['preprocess']['target_lang']]],
        ...
        if args['preprocess']['srcdict']:
            ...
            src_dict = build_dictionary([train_path(args['preprocess']['source_lang']), valid_path(args['preprocess']['source_lang'])],
                                        args['preprocess']['source_lang'], src=True)
        ...
        if target:
            if args['preprocess']['tgtdict']:
                ...
                tgt_dict = build_dictionary([train_path(args['preprocess']['target_lang']), valid_path(args['preprocess']['target_lang'])],
