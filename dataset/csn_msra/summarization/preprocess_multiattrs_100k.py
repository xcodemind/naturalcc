...
def cli_main():
    ...
    LOGGER.info(args)
    yaml_file = os.path.join(os.path.dirname(__file__), 'config_100k', 'preprocess_multiattrs_{}.yml'.format(args.language))
...
if __name__ == "__main__":
    ...
    nohup python -m dataset.csn.summarization.preprocess_multiattrs -l python > python.log  2>&1 &
    nohup python -m dataset.csn.summarization.preprocess_multiattrs -l php > php.log  2>&1 &
