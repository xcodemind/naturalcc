...
def main(args):
    ...
    def build_dictionary(filenames, modality, src=False, tgt=False):
        ...
        elif modality in ['code_tokens', 'code_tokens.subtoken', 'docstring_tokens', 'docstring_tokens.subtoken']:
    ...
    for attr in args['preprocess']['source_lang']:
        if args['preprocess']['srcdict']:
            ...
            if os.path.exists(dict_filename):
                ...
                if attr in ['code_tokens', 'code_tokens.subtoken']:
                    attr_dict = build_dictionary([train_path(attr), valid_path(attr)], attr, src=True)
                elif attr in ['docstring_tokens', 'docstring_tokens.subtoken']:
