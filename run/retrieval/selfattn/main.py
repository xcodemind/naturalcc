...
def main():
    ...
    # for debug
    # nohup python -u ./run/retrieval/unilang/selfattn/main.py > ./run/retrieval/unilang/selfattn/retrieval_*.log 2>&1 &
    Argues = namedtuple('Argues', 'yaml task lang_mode method_name train_mode dataset_type multi_processing')
    # args_ = Argues('ruby.yml', 'retrieval', 'unilang', 'selfattn', 'train_sl', 'source', True)  # train_sl
    # args_ = Argues('python.yml', 'retrieval', 'unilang', 'selfattn', 'train_sl', 'source', True)  # train_sl
    # args_ = Argues('php.yml', 'retrieval', 'unilang', 'selfattn', 'train_sl', 'source', True)  # train_sl
    # args_ = Argues('go.yml', 'retrieval', 'unilang', 'selfattn', 'train_sl', 'source', True)  # train_sl
    # args_ = Argues('javascript.yml', 'retrieval', 'unilang', 'selfattn', 'train_sl', 'source', True)  # train_sl

    args_ = Argues('python.yml', 'retrieval', 'unilang', 'selfattn', 'test', 'source', True)  # train_sl
    LOGGER.info(args_)
    ...
    model = build_model(args, RNNSelfAttn(args))
    LOGGER.info(model)
