...
def main():
    ...
    # for debug
    # nohup python -u ./run/retrieval/unilang/birnn/main.py > ./run/retrieval/unilang/birnn/retrieval_*.log 2>&1 &
    Argues = namedtuple('Argues', 'yaml task lang_mode method_name train_mode dataset_type multi_processing')
    # args_ = Argues('ruby.yml', 'retrieval', 'unilang', 'birnn', 'train_sl', 'source', True)  # train_sl
    # args_ = Argues('php.yml', 'retrieval', 'unilang', 'birnn', 'train_sl', 'source', True)  # train_sl
    # args_ = Argues('go.yml', 'retrieval', 'unilang', 'birnn', 'train_sl', 'source', True)  # train_sl
    # args_ = Argues('java.yml', 'retrieval', 'unilang', 'birnn', 'train_sl', 'source', True)  # train_sl
    # args_ = Argues('javascript.yml', 'retrieval', 'unilang', 'birnn', 'train_sl', 'source', True)  # train_sl

    args_ = Argues('javascript.yml', 'retrieval', 'unilang', 'birnn', 'test', 'source', True)  # test
    LOGGER.info(args_)
    ...
    model = build_model(args, BiRNN(args))
    LOGGER.info(model)
