...
def main():
    ...
    # args = Argues('ruby.yml', 'retrieval', 'unilang', 'birnn', 'train_sl', 'source', True)  # train_sl
    # args = Argues('php.yml', 'retrieval', 'unilang', 'birnn', 'train_sl', 'source', True)  # train_sl
    # args = Argues('go.yml', 'retrieval', 'unilang', 'birnn', 'train_sl', 'source', True)  # train_sl
    # args = Argues('java.yml', 'retrieval', 'unilang', 'birnn', 'train_sl', 'source', True)  # train_sl
    # args = Argues('javascript.yml', 'retrieval', 'unilang', 'birnn', 'train_sl', 'source', True)  # train_sl

    args = Argues('javascript.yml', 'retrieval', 'unilang', 'birnn', 'test', 'source', True)  # test
    LOGGER.info(args)
    ...
    model = build_model(config, BiRNN(config))
    LOGGER.info(model)
