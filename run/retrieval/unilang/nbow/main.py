...
def main():
    ...
    # args_ = Argues('config.yml', 'retrieval', 'unilang', 'nbow', 'train_sl', 'source', True)  # train_sl
    # args_ = Argues('go.yml', 'retrieval', 'unilang', 'nbow', 'test', 'source', True)  # test
    LOGGER.info(args_)
    ...
    model = build_model(args, NBOW(args))
    LOGGER.info(model)

    # train_sl
    if args_.train_mode == 'all' or args_.train_mode == 'train_sl':
    ...
    # test
    if args_.train_mode == 'all' or args_.train_mode == 'test':
