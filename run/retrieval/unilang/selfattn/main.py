...
def main():
    ...
    # args = Argues('ruby.yml', 'retrieval', 'unilang', 'selfattn', 'train_sl', 'source', True)  # train_sl
    # args = Argues('python.yml', 'retrieval', 'unilang', 'selfattn', 'train_sl', 'source', True)  # train_sl
    # args = Argues('php.yml', 'retrieval', 'unilang', 'selfattn', 'train_sl', 'source', True)  # train_sl
    # args = Argues('go.yml', 'retrieval', 'unilang', 'selfattn', 'train_sl', 'source', True)  # train_sl
    # args = Argues('javascript.yml', 'retrieval', 'unilang', 'selfattn', 'train_sl', 'source', True)  # train_sl

    args = Argues('python.yml', 'retrieval', 'unilang', 'selfattn', 'test', 'source', True)  # train_sl
    LOGGER.info(args)
    ...
    model = build_model(config, RNNSelfAttn(config))
    LOGGER.info(model)
