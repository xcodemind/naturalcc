...
def cli_main():
    ...
    parser.add_argument(
        "--language", "-l", default='csn', type=str, help="load {language}.yml for train",
    )
    args = parser.parse_args()
    # Argues = namedtuple('Argues', 'yaml')
    # args_ = Argues('ruby.yml')
    yaml_file = os.path.join(os.path.dirname(__file__), 'config', 'pretrain', '{}.yml'.format(args.language))
