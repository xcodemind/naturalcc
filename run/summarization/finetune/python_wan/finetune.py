...
def single_main(args, init_distributed=False):
    ...
    LOGGER.info('Load pretrained model from {}'.format(args['checkpoint']['pretrained_model']))
    state = checkpoint_utils.load_checkpoint_to_cpu(args['checkpoint']['pretrained_model'])
