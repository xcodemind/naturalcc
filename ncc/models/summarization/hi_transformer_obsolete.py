...
class HiTransformerModel(FairseqModel):
    ...
    def build_model(cls, args, config, task):
        ...
        decoder = HiTransformerDecoder(args, src_dict, tgt_dict, decoder_embed_tokens)
        return HiTransformerModel(encoder, decoder)
...
class HiTransformerEncoder(FairseqEncoder):
    """Transformer encoder."""
...
class HiTransformerDecoder(FairseqIncrementalDecoder):
    """Transformer decoder."""
