...
static PyMethodDef __pyx_methods[] = {
  {"batch_by_size_fast", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3ncc_4data_15data_utils_fast_1batch_by_size_fast, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init ncc.data.data_utils_fast", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
