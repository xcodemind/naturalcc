...
# def load_pathindexed_dataset(path, dictionary=None, tokenizer=None, dataset_impl=None, combine=False, default='cached'):
#     """A helper function for loading indexed datasets.
#
#     Args:
#         path (str): path to indexed dataset (e.g., 'data-bin/train')
...
#
#
# def load_astindexed_dataset(path, dictionary=None, tokenizer=None, dataset_impl=None, combine=False, default='cached'):
#     """A helper function for loading indexed datasets.
#
#     Args:
#         path (str): path to indexed dataset (e.g., 'data-bin/train')
