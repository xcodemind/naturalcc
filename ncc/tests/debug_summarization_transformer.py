...
if __name__ == '__main__':
    ...
    args_ = Argues('csharp-bpe.yml')  # train_sl
    LOGGER.info(args_)
    print('args: ', type(args_))
    # yaml_file = os.path.join('../../../naturalcodev3/run/summarization/lstm2lstm/', 'config', args_.yaml)
    yaml_file = os.path.join('../../../naturalcodev3/run/summarization/transformer/', 'config', args_.yaml)
    ...
    data_path = os.path.expanduser('~/.ncc/codenn/summarization_bpe/data-mmap/csharp')
    split = 'train'
